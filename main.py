...
class MainWindow(QMainWindow):
    ...
    def _setup_sidebar(self, parent_layout: QHBoxLayout) -> None:
        ...
        btn_manajemen = QPushButton(icon("project.png"), "Manajemen Proyek")
        btn_kanban = QPushButton(icon("board.png"), "Kanban Board")
        btn_laporan = QPushButton(icon("report.png"), "Laporan Kinerja")
    ...
    def _setup_pages(self, parent_layout: QHBoxLayout) -> None:
        ...
        QVBoxLayout(self.page_kanban).addWidget(QLabel("Kanban Board"), alignment=Qt.AlignCenter)
